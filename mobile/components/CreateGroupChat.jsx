    ...
    const handleCreateGroup = () => {
        ...
        socketConnection.on("groupCreated", (response) => {
            ...
            if (response && response.success) {
                ...
                Alert.alert(
                    "Lỗi",
                    response?.message || "Không thể tạo nhóm chat, vui lòng thử lại"
                );
            }
        });
        ...
        const memberIds = selectedUsers.map(id =>
        ...
        >
            <View className="flex-1 bg-black bg-opacity-50 justify-center items-center">
                <View className="bg-white w-[90%] rounded-xl p-5 max-h-[80%]">
                    ...
                    {isCreatingGroup && (
                        <View className="mb-4 bg-blue-50 p-3 rounded-lg">
                            ...
                            <Text className="text-blue-600 text-center">
                                Đang tạo nhóm chat, vui lòng đợi...
                            </Text>
                        </View>
                    )}
                    ...
                    {/* Create group button */}
                    <TouchableOpacity
                        className={`mt-4 py-3 rounded-lg items-center ${groupName.trim() && selectedUsers.length >= 2 && socketStatus.connected
                            ? 'bg-blue-500'
                            : 'bg-gray-300'
                            }`}
