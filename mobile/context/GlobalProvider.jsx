...
export const GlobalProvider = ({ children }) => {
    ...
    const checkAuth = async () => {
      try {
        ...
        if (token) {
          ...
          try {
            const response = await axios.get(`${REACT_APP_BACKEND_URL}/api/validate-token`, {
              headers: {
            ...
            if (response.data.valid) {
              ...
              // Fetch user details
              const userResponse = await axios.get(`${REACT_APP_BACKEND_URL}/api/user-details`, {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
  ...
  const refreshToken = async () => {
    try {
      ...
      const response = await axios.post(`${REACT_APP_BACKEND_URL}/api/refresh-token`, {
